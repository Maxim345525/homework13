...
int main() {
    ...
    cout << "ћасив :" << endl;
    printarr(arr, n);
    cout << "«находимо суму вiд'Їмних елементiв" << endl;
    sumnegative(arr, n);
    cout << "«находимо добуток елементiв мiж min i max" << endl;
    summintomax(arr, n);
    cout << "«находимо добуток елементiв з парними номерами" << endl;
    sumpair(arr, n);
    cout << "«находимо добуток елементiв мiж першим i останнiм вiд'Їмним елементом" << endl;
    sumnegtoneg(arr, n);
    return 0;
